...
namespace Org.OpenAPITools.Test.Api
{
    ...
    public class ObservingConditionsSpecificMethodsApiTests : IDisposable
    {
        ...
        {
            instance = new ObservingConditionsSpecificMethodsApi("http://localhost:5000/api/v1/");
        }
        ...
        public void ObservingconditionsDeviceNumberRefreshPutTest()
        {
            ...
            int? clientID = null;
            int? clientTransactionID = null;
            var response = instance.ObservingconditionsDeviceNumberRefreshPut(deviceNumber, clientID, clientTransactionID);
            Assert.IsType<Response>(response);
        }
